...
/**
 * @ngdoc function
 * @name testcallApp.controller:MainCtrl
 * @description
 * # MainCtrl
 * Controller of the testcallApp
 */
...
angular.module('testcallApp')
  .controller('MainCtrl', function ($scope,$http) {
    ...
    $scope.init = function () {
         $http.get('/scripts/controllers/myevents1.json').then(function (result) {
             $scope.demoEvents = result
         });
    }();
});
